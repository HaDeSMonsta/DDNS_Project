...
docker build ./ddns_server/ -f ddns_server/docker/default/release/Dockerfile -t "ghcr.io/hadesmonsta/ddns_project:server-v${full}"
docker build ./ddns_server/ -f ddns_server/docker/nc/release/Dockerfile -t "ghcr.io/hadesmonsta/ddns_project:server-netcup-v${full}"
